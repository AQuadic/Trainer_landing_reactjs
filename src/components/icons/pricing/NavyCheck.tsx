const NavyCheck = () => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_70_1990" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="1" y="1" width="22" height="22">
            ...
            <g mask="url(#mask0_70_1990)">
            <path d="M0 0H24V24H0V0Z" fill="#001B3F"/>
            </g>
        </svg>
    )
}

export default NavyCheck
